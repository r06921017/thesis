...
if __name__ == '__main__':
    ...
    plt.grid(True)
    plt.plot(num, fcfs, linewidth=3.0, color='blue', marker='o', ms=14, label='FCFS', zorder=1)
    plt.plot(num, rand, linewidth=3.0, color='purple', marker='D', ms=14, label='Random', zorder=2)
    plt.plot(num, pf, linewidth=3.0, color='green', marker='P', ms=14, label='PF', zorder=3)
    plt.plot(num, sf, linewidth=3.0, color='orange', marker='X', ms=14, label='SF', zorder=5)
    ...
    plt.title('Total Processing Time', fontsize=25)
